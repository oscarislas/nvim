...
vim.api.nvim_set_keymap('n', '<leader>sa', [[<cmd>lua require('telescope.builtin').find_files()<CR>]], { noremap = true, silent = true })
...
local on_attach = function(_, bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>e', '<cmd>lua vim.lsp.diagnostic.show()<CR>', opts)
...
dap.adapters.php = {
  type = 'executable',
  command = 'node',
  args = { '/Users/oislasortega/Code/vscode-php-debug/out/phpDebug.js' }
}
...
dap.configurations.php = {
  {
    ...
    port = 9003,
    client_host = 'mono-oislasortega.l.coursehero.io',
    serverSourceRoot = '/var/www/html/coursehero/src/',
    localSourceRoot = '/Users/oislasortega/Code/coursehero/',
  }
}
